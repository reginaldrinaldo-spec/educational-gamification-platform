...
def register_routes(app: Flask):
    ...
    # ----- TEMP SEED ENDPOINT -----
@app.post("/api/temp-seed-questions")
def temp_seed_questions():
    """
    Temporary endpoint to quickly seed quiz questions.
    This will be removed after initial seeding.
    """
    try:
        from models import Question, Quiz
        
        # Clear existing questions (optional - be careful!)
        # Question.query.delete()
        
        # Get or create default quiz
        quiz = Quiz.query.first()
        if not quiz:
            quiz = Quiz(title="Educational Quiz", description="MeMe Educational Platform Quiz")
            db.session.add(quiz)
            db.session.flush()
        
        questions_data = [
            # Wiskunde & Wetenschap
            {'text': 'Wat is 7 x 8?', 'options': '["A. 54", "B. 56", "C. 58", "D. 60"]', 'correct': 'B', 'diff': 'easy', 'cat': 'Wiskunde & Wetenschap', 'exp': '7 x 8 = 56'},
            {'text': 'Hoeveel planeten zijn er in ons zonnestelsel?', 'options': '["A. 7", "B. 8", "C. 9", "D. 10"]', 'correct': 'B', 'diff': 'easy', 'cat': 'Wiskunde & Wetenschap', 'exp': 'Er zijn 8 planeten'},
            {'text': 'Wat is de hoofdstad van Frankrijk?', 'options': '["A. Londen", "B. Berlijn", "C. Parijs", "D. Rome"]', 'correct': 'C', 'diff': 'easy', 'cat': 'Wiskunde & Wetenschap', 'exp': 'Parijs is de hoofdstad'},
            {'text': 'Wat is de wortel van 144?', 'options': '["A. 10", "B. 11", "C. 12", "D. 13"]', 'correct': 'C', 'diff': 'medium', 'cat': 'Wiskunde & Wetenschap', 'exp': '12 x 12 = 144'},
            {'text': 'Wat is de snelheid van het licht?', 'options': '["A. 300.000 km/s", "B. 150.000 km/s", "C. 450.000 km/s", "D. 600.000 km/s"]', 'correct': 'A', 'diff': 'medium', 'cat': 'Wiskunde & Wetenschap', 'exp': 'Licht reist met 300.000 km/s'},
            # Taal & Communicatie
            {'text': 'Welke letter komt na Q in het alfabet?', 'options': '["A. P", "B. R", "C. S", "D. T"]', 'correct': 'B', 'diff': 'easy', 'cat': 'Taal & Communicatie', 'exp': 'R komt na Q'},
            {'text': 'Hoeveel letters zitten er in het Nederlands alfabet?', 'options': '["A. 24", "B. 25", "C. 26", "D. 27"]', 'correct': 'C', 'diff': 'easy', 'cat': 'Taal & Communicatie', 'exp': '26 letters'},
            {'text': 'Wat is een synoniem voor gelukkig?', 'options': '["A. Verdrietig", "B. Blij", "C. Boos", "D. Bang"]', 'correct': 'B', 'diff': 'easy', 'cat': 'Taal & Communicatie', 'exp': 'Blij = gelukkig'},
            {'text': 'Welk leesteken gebruik je aan het einde van een vraag?', 'options': '["A. Punt", "B. Komma", "C. Vraagteken", "D. Uitroepteken"]', 'correct': 'C', 'diff': 'easy', 'cat': 'Taal & Communicatie', 'exp': 'Vraagteken bij vragen'},
            {'text': 'Wat is een antoniem van groot?', 'options': '["A. Klein", "B. Hoog", "C. Breed", "D. Lang"]', 'correct': 'A', 'diff': 'easy', 'cat': 'Taal & Communicatie', 'exp': 'Klein is tegenovergestelde van groot'},
            # Gezondheid & Sport
            {'text': 'Hoeveel spelers heeft een voetbalteam op het veld?', 'options': '["A. 9", "B. 10", "C. 11", "D. 12"]', 'correct': 'C', 'diff': 'easy', 'cat': 'Gezondheid & Sport', 'exp': '11 spelers per team'},
            {'text': 'Welke vitamine krijg je van de zon?', 'options': '["A. Vitamine A", "B. Vitamine B", "C. Vitamine C", "D. Vitamine D"]', 'correct': 'D', 'diff': 'easy', 'cat': 'Gezondheid & Sport', 'exp': 'Zon geeft vitamine D'},
            {'text': 'Hoeveel uur slaap heeft een kind van 10 jaar nodig?', 'options': '["A. 6-7 uur", "B. 8-9 uur", "C. 9-11 uur", "D. 12-14 uur"]', 'correct': 'C', 'diff': 'easy', 'cat': 'Gezondheid & Sport', 'exp': '9-11 uur is ideaal'},
            {'text': 'Welke sport wordt gespeeld op een court?', 'options': '["A. Voetbal", "B. Tennis", "C. Zwemmen", "D. Hardlopen"]', 'correct': 'B', 'diff': 'easy', 'cat': 'Gezondheid & Sport', 'exp': 'Tennis op een court'},
            {'text': 'Wat is goed voor sterke botten?', 'options': '["A. Suiker", "B. Calcium", "C. Zout", "D. Vet"]', 'correct': 'B', 'diff': 'easy', 'cat': 'Gezondheid & Sport', 'exp': 'Calcium voor sterke botten'},
        ]
        ...
        return jsonify({
            "message": "Successfully seeded 15 quiz questions",
            "quiz_id": quiz.id,
            "question_count": len(questions_data)
        }), 201
